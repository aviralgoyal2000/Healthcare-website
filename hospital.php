...
<html>
  ...
  <body>
    ...
    <div id="container-main">
      <form name="hos" onsubmit="return validateForm()" method="post" action="hospital.php">
        <div class="container">
          ...
          <hr>
          <b>Hospital name</b><span class="req"> *<?php echo $Mes_User1 ?></span>
          <input type="text" placeholder="Enter Hospital name" name="hosp_name" id="hosp_name">
          <b>Hospital Location</b><span class="req"> *<?php echo $Mes_User2 ?></span>
          <input type="text" placeholder="Location" name="location" id="hosp_loc">
          <button onclick="getLocation()">get location</button>
          <br><br>
          <b>Hospital Specialization</b><span class="req"> *<?php echo $Mes_User3 ?></span>
